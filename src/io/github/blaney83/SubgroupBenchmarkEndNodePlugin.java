 ...
 */
public class SubgroupBenchmarkEndNodePlugin extends Plugin {
    // The shared instance.
    private static SubgroupBenchmarkEndNodePlugin plugin;

    /**
     * The constructor.
     */
    public SubgroupBenchmarkEndNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SubgroupBenchmarkEndNodePlugin getDefault() {
        return plugin;
    }
